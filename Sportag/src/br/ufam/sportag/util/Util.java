...
public class Util {
	...
	public static String venuesRequestUrl = "https://api.foursquare.com/v2/venues/search";
	...
	public static String deleteUrl = "http://sportag.net76.net/delete.php";
	public static int[] sportsDrawables = { R.drawable.icone_futebol_thumb,
			R.drawable.icone_volei_thumb, R.drawable.icone_handebol_thumb,
			R.drawable.icone_basquete_thumb, R.drawable.icone_natacao_thumb,
			R.drawable.icone_corrida_thumb, R.drawable.icone_caminhada_thumb,
			R.drawable.icone_skate_thumb, R.drawable.icone_patins_thumb};
	...
	public User createUser(JSONObject jsonUser) throws JSONException {
		...
		String photoURL = photo.optString("prefix") + "100x100"
